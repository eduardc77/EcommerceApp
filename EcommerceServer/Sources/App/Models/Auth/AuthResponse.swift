...
struct AuthResponse: Codable, Sendable {
    ...
    init(accessToken: String, refreshToken: String, expiresIn: UInt, expiresAt: String, user: UserResponse, requiresTOTP: Bool = false, requiresEmailVerification: Bool = false) {
